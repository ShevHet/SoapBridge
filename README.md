...
- **SOAP сервис недоступен:** `http://isapi.mekashron.com/icu-tech/icutech-test.dll` возвращает HTML вместо SOAP XML
- **Решение для тестирования:** Используйте Mock клиент (`USE_MOCK_SOAP_CLIENT=true`)
- **В production:** Mock клиент возвращает предустановленные успешные ответы для демонстрации
